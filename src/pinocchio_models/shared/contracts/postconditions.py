...
def _collect_link_names_and_joints(
    ...
    # ⚡ Bolt Optimization: local caching to avoid attribute lookups in hot loop
    ...
    for el in root.iter():
        ...
        # ⚡ Bolt Optimization: fast path checking string membership first.
        # Python's `in` operator safely handles callables (like Comments) returning False.

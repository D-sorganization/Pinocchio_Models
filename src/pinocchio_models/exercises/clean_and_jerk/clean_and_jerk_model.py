...
class CleanAndJerkModelBuilder(ExerciseModelBuilder):
    ...
    def set_initial_pose(self, robot: ET.Element) -> None:
        ...
        set_joint_default(robot, "lumbar", CLEAN_AND_JERK_LUMBAR_ANGLE, exact_suffix="_flex")
        set_joint_default(robot, "ankle", CLEAN_AND_JERK_ANKLE_ANGLE, exact_suffix="_flex")

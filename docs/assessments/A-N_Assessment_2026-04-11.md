...
- Python test functions (`def test_*`): 365
- Approx test-per-100-LOC: 5.0

### Code Churn Since 2026-04-10

- Commits since 2026-04-10: 5
- Files touched (top 30): 6

<details><summary>Changed files</summary>

- `docs/assessments/A-N_Assessment_2026-04-10.md`
- `src/pinocchio_models/addons/crocoddyl/optimal_control.py`
- `src/pinocchio_models/addons/pink/ik_solver.py`
- `src/pinocchio_models/shared/body/body_model.py`
- `tests/unit/addons/test_crocoddyl_oc.py`
- `tests/unit/addons/test_pink_ik.py`
...
| Script | LOC |
|---|---|
| `src/pinocchio_models/addons/pink/ik_solver.py` | 325 |
| `src/pinocchio_models/addons/crocoddyl/optimal_control.py` | 324 |
| `src/pinocchio_models/shared/body/body_model.py` | 308 |
...
### TDD
- 365 test functions across 27 test files.
...
2. **P1 (Monoliths)**: Split top-3 monolithic scripts into focused modules. Keep all scripts short and singularly purposed.
   - `src/pinocchio_models/addons/pink/ik_solver.py` (325 LOC)
   - `src/pinocchio_models/addons/crocoddyl/optimal_control.py` (324 LOC)

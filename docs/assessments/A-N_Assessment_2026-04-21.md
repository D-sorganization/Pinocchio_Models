# A-N Assessment - Pinocchio_Models - 2026-04-21
...
- Reviewed 143 tracked files, including 105 code files, 41 test files, 1 CI files, 2 config/build files, and 30 docs/onboarding files.
...
- Evidence: `143 tracked first-party files`

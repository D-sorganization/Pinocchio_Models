...
class TestModelGenerationBenchmark:
    @pytest.mark.slow()
    def test_squat_generation(self, benchmark: object) -> None:
        benchmark(build_squat_model)

    @pytest.mark.slow()
    def test_bench_press_generation(self, benchmark: object) -> None:
        benchmark(build_bench_press_model)

    @pytest.mark.slow()
    def test_deadlift_generation(self, benchmark: object) -> None:
        benchmark(build_deadlift_model)

    @pytest.mark.slow()
    def test_snatch_generation(self, benchmark: object) -> None:
        benchmark(build_snatch_model)

    @pytest.mark.slow()
    def test_clean_and_jerk_generation(self, benchmark: object) -> None:
